%%
% Project Name: USSP
% Description: Generate uniformly distribution test samples of experiment 5.2
% Author: Yang Jinjing
...
function [ss] = Sample_Generate_GP_OneRegion_Test(n,seed)
rng(seed,'twister');   
X0 = unifrnd(-3,3, [n,5]);   %% Uniformly distribution x
